{
    ...
    obj_building_cube_2.visible = true;
    obj_building_cube_3.visible = true;
    obj_building_cube_4.visible = true;
    obj_building_shop.visible = true;
    obj_building_weird.visible = true;
